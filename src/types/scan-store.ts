...
export interface SerializedDuplicateGroup extends Omit<
  DuplicateGroup,
  "selectedForDeletion"
> {
...
export interface SerializedSameFolderGroup extends Omit<
  SameFolderGroup,
  "sets"
> {
...
export interface SerializedScanResult extends Omit<
  ScanResult,
